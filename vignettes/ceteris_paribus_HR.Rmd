...
plot(cp_rf3, 
     ...
     as.gg = TRUE) + xlab("") +  scale_y_continuous(limits=c(0,1), name = "Pr(promoted)", labels = scales::percent) + theme_light()
...
plot(cp_rf1, cp_rf2, cp_rf3, 
     ...
     as.gg = TRUE) + xlab("") +  scale_y_continuous(limits=c(0,1), name = "Pr(promoted)", labels = scales::percent) + theme_light() + scale_color_discrete(name = "class")
