...
Coral Plots are something between Ceteris Paribus Plots (profile for single observation) and Partial Dependency Plots (average from all profiles).

Coral Plots show profiles for observations close to a selected point in feature space. Additionally they show also residuals for these neighbours.
